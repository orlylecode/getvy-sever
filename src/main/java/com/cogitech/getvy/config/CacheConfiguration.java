package com.cogitech.getvy.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cogitech.getvy.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cogitech.getvy.repository.UserRepository.USERS_BY_EMAIL_CACHE);
