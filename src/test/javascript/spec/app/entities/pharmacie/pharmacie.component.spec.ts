...
import { PharmacieComponent } from 'app/entities/pharmacie/pharmacie.component';
...
describe('Component Tests', () => {
  describe('Pharmacie Management Component', () => {
    let comp: PharmacieComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PharmacieComponent, '')
        .compileComponents();
