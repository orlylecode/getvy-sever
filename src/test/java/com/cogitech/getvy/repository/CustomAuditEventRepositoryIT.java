...
import com.cogitech.getvy.config.audit.AuditEventConverter;
import com.cogitech.getvy.domain.PersistentAuditEvent;
...
import static com.cogitech.getvy.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
